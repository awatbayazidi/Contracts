<?php namespace AwatBayazidi\Contracts\AtbAuth;
...
interface Role
{
     ...
     *
    // * @param  \AwatBayazidi\Contracts\Auth\Models\User|int  $user
     * @param  bool                                    $reload
     */
   ...
   //  * @param  \AwatBayazidi\Contracts\Auth\Models\User|int  $user
     ...
     *
   //  * @param  \AwatBayazidi\Contracts\Auth\Models\User|int  $id
     *
     * @return bool
     */
     ...
     * Attach a permission to a role.
     *
   //  * @param  \AwatBayazidi\Contracts\Auth\Models\Permission|int  $permission
     * @param  bool                                          $reload
     */
